...
$fileList=get_infoList(4,$infoId);
$infoTitle="";
$infoContent="";
if(is_array($fileList)){
	$infoTitle=$fileList["infoTitle"];
	$infoContent=$fileList["infoContent"];
}else{
...
<div class="right-main">
	<form name="myForm" enctype="multipart/form-data" method="POST" action="file_insert_update_delete.php">
		...
		<div id="search" class="search">
		    <table border="0" cellpadding="0" cellspacing="1" class="tab">
			    <tbody>
			    	<tr>
				    	<td height="25" colspan="4" class="tab-title" align="center">发布督查文件</td>
				    </tr>
				    <tr>
