...
$(function () {
 var typeArr = new Array('','重点工作','重大事项','市长台账','领导批示','会议纪要','建议提案','舆情监控','民生工程','中央项目');
	...
	Highcharts.setOptions({
        colors: ['#50B432', '#b91903', '#058DC7', '#DDDF00', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4', '#3A59C4']
    });
	//总任务统计图
	...
	Highcharts.chart('chartdiv2', {
					...
					click: function(e) {
						for(var i=0; i<typeArr.length; i++){
							if(e.point.name == typeArr[i]){
								window.location.href = "../taizhang/taskreview.php?taskstate_a=1&tasktypes="+i;
							}
						}
					}
				}
        ...
        series: [{
            ...
            data: [{
				...
				name: typeArr[9],
				y: <?php echo $taskArr[8]["uncomplete"]; ?>
			}
			]
        }]
    });
            ...
            pie: {
				...
				events: {
					click: function(e) {
						for(var i=0; i<typeArr.length; i++){
							if(e.point.name == typeArr[i]){
								window.location.href = "../taizhang/taskreview.php?taskstate_a=3&tasktypes="+i;
							}
						}
					}
				}
