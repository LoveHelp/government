...
<script>
$(function () {
 var typeArr = new Array('','重点工作','重大事项','市长台账','领导批示','会议纪要','建议提案','舆情监控','民生工程','中央项目');
	<?php 
		if($taskArr["count"] == 0){
	?>
		$("#chartdiv").html("暂无数据！");
    ...
    $('#chartdiv').highcharts({
        ...
        xAxis: {
            categories: ['重点工作','重大事项','市长台账','领导批示','会议纪要','建议提案','舆情监控','民生工程','中央项目'],
            crosshair: true
        },
        yAxis: {
            min: 0,
        ...
        series: [{
            ...
            data: [
				...
				{num:<?php echo $taskArr['uncomplete'][8]; ?>, y:<?php echo $taskArr['uncom_rate'][8]; ?>}
			]
        }, {
           name: '已完成',
            data: [
				...
				{num:<?php echo $taskArr['complete'][7]; ?>, y:<?php echo $taskArr['com_rate'][8]; ?>},
		   ]
        }]
    });
	...
	<div id="result">
		<form name="queryForm2" method="get" action="taizhang.php?do=cartogram" target="">
			<table cellpadding="0" cellspacing="0" border="0" align="center" class="tab" style="overflow-x:auto;">
				...
				<tr>
					<td width="100%" bgcolor="#fff">
						<div id="chartdiv" align="center" style="width:100%;border-bottom:1px solid #ccc;"></div>
					</td>
				</tr>
			</table>
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" class="tab">
				...
				<tr>
					<td width="100%" bgcolor="#fff">
						<div id="chartdiv2" align="center" style="width:100%;border-bottom:1px solid #ccc;"></div>
					</td>
				</tr>
			</table>
		</form>
